  ...
  <drawing>
    ...
    <schematic xreflabel="%F%N/%S.%C%R" xrefpart="/%S.%C%R">
      ...
      <sheets>
        <sheet>
          <plain>
            <text x="0" y="0" size="1.27" layer="94">Generated schematic scaffold. Use scripts/rebuild_schematic.scr for full reconstruction.</text>
            <text x="0" y="-2.54" size="1.27" layer="94">Components=2 Nets=1 Sheets=1</text>
          </plain>
          <instances/>
          <busses/>
          <nets/>
